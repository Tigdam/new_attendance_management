...
public class Tadaptor extends FirebaseRecyclerAdapter<Tlist, Tadaptor.PastViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull PastViewHolder holder, int position, @NonNull Tlist model) {
        ...
        if(position == 0)
        {
            holder.tr.setBackgroundColor(Color.GREEN);
        }
        else
        {
            holder.tr.setBackgroundColor(Color.WHITE);
        }
